        ...
        [14], {
            49: function(e, t, n) {
                ...
                e.exports = function() {
                    ...
                    var f, m = w(Array.prototype.forEach),
                    ...
                    var E = i(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
                        ...
                        _ = i(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]),
                    ...
                    return function e() {
                        ...
                        var pe = z,
                            ...
                            be = j,
                            Ae = null,
                            Te = x({}, [].concat(q(E), q(R), q(_), q(N), q(L))),
                            we = null,
                            xe = x({}, [].concat(q(M), q(F), q(I), q(C))),
                            Se = null,
                            ke = null,
                            Ee = !0,
                            Re = !0,
                            ...
                            He = !1,
                            Pe = {},
                            je = x({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]),
                            We = null,
                            Be = x({}, ["audio", "video", "img", "source", "image", "track"]),
                            Ge = null,
                            ...
                            Ze = function(e) {
                                Xe && Xe === e || (e && "object" === (void 0 === e ? "undefined" : G(e)) || (e = {}), e = S(e), Ae = "ALLOWED_TAGS" in e ? x({}, e.ALLOWED_TAGS) : Te, we = "ALLOWED_ATTR" in e ? x({}, e.ALLOWED_ATTR) : xe, Ge = "ADD_URI_SAFE_ATTR" in e ? x(S(qe), e.ADD_URI_SAFE_ATTR) : qe, We = "ADD_DATA_URI_TAGS" in e ? x(S(Be), e.ADD_DATA_URI_TAGS) : Be, Se = "FORBID_TAGS" in e ? x({}, e.FORBID_TAGS) : {}, ke = "FORBID_ATTR" in e ? x({}, e.FORBID_ATTR) : {}, Pe = "USE_PROFILES" in e && e.USE_PROFILES, Ee = !1 !== e.ALLOW_ARIA_ATTR, Re = !1 !== e.ALLOW_DATA_ATTR, _e = e.ALLOW_UNKNOWN_PROTOCOLS || !1, De = e.SAFE_FOR_TEMPLATES || !1, Ne = e.WHOLE_DOCUMENT || !1, Me = e.RETURN_DOM || !1, Fe = e.RETURN_DOM_FRAGMENT || !1, Ie = !1 !== e.RETURN_DOM_IMPORT, Ce = e.RETURN_TRUSTED_TYPE || !1, Le = e.FORCE_BODY || !1, ze = !1 !== e.SANITIZE_DOM, Ue = !1 !== e.KEEP_CONTENT, He = e.IN_PLACE || !1, be = e.ALLOWED_URI_REGEXP || be, Je = e.NAMESPACE || Ye, De && (Re = !1), Fe && (Me = !0), Pe && (Ae = x({}, [].concat(q(L))), we = [], !0 === Pe.html && (x(Ae, E), x(we, M)), !0 === Pe.svg && (x(Ae, R), x(we, F), x(we, C)), !0 === Pe.svgFilters && (x(Ae, _), x(we, F), x(we, C)), !0 === Pe.mathMl && (x(Ae, N), x(we, I), x(we, C))), e.ADD_TAGS && (Ae === Te && (Ae = S(Ae)), x(Ae, e.ADD_TAGS)), e.ADD_ATTR && (we === xe && (we = S(we)), x(we, e.ADD_ATTR)), e.ADD_URI_SAFE_ATTR && x(Ge, e.ADD_URI_SAFE_ATTR), Ue && (Ae["#text"] = !0), Ne && x(Ae, ["html", "head", "body"]), Ae.table && (x(Ae, ["tbody"]), delete Se.tbody), i && i(e), Xe = e)
                            },
                            et = x({}, ["mi", "mo", "mn", "ms", "mtext"]),
                            tt = x({}, ["foreignobject", "desc", "title", "annotation-xml"]),
                            nt = x({}, R);
                        x(nt, _), x(nt, D);
                        var rt = x({}, N);
                        x(rt, O);
                        var ot = function(e) {
                            ...
                            ut = function(e) {
                                var t, r = void 0;
                                if (st("beforeSanitizeElements", e, null), !((t = e) instanceof Y || t instanceof J || "string" == typeof t.nodeName && "string" == typeof t.textContent && "function" == typeof t.removeChild && t.attributes instanceof w && "function" == typeof t.removeAttribute && "function" == typeof t.setAttribute && "string" == typeof t.namespaceURI && "function" == typeof t.insertBefore)) return ot(e), !0;
                                if (g(e.nodeName, /[\u0080-\uFFFF]/)) return ot(e), !0;
                                var o = h(e.nodeName);
                                if (st("uponSanitizeElement", e, {
                                        tagName: o,
                                        allowedTags: Ae
                                    }), !ct(e.firstElementChild) && (!ct(e.content) || !ct(e.content.firstElementChild)) && A(/<[/\w]/g, e.innerHTML) && A(/<[/\w]/g, e.textContent)) return ot(e), !0;
                                if (!Ae[o] || Se[o]) {
                                    if (Ue && !je[o]) {
                                        var i = ne(e) || e.parentNode,
                                            a = te(e) || e.childNodes;
                                        if (a && i)
                                            for (var l = a.length, c = l - 1; c >= 0; --c) i.insertBefore(Z(a[c], !0), ee(e))
                                    }
                                    return ot(e), !0
                                }
                                return e instanceof s && ! function(e) {
                                    var t = ne(e);
                                    t && t.tagName || (t = {
                                        namespaceURI: Ye,
                                        tagName: "template"
                                    ...
                                    return !1
                                }(e) ? (ot(e), !0) : "noscript" !== o && "noembed" !== o || !A(/<\/no(script|embed)/i, e.innerHTML) ? (De && 3 === e.nodeType && (r = e.textContent, r = y(r, pe, " "), r = y(r, de, " "), e.textContent !== r && (d(n.removed, {
                                    element: e.cloneNode()
                                }), e.textContent = r)), st("afterSanitizeElements", e, null), !1) : (ot(e), !0)
                            },
                            ft = function(e, t, n) {
                                if (ze && ("id" === t || "name" === t) && (n in o || n in $e)) return !1;
                                if (Re && A(he, t));
                                else if (Ee && A(ge, t));
                                else {
                                    if (!we[t] || ke[t]) return !1;
                                    if (Ge[t]);
                                    else if (A(be, y(n, ve, "")));
                                ...
                                if (a) {
                                    ...
                                    for (i = a.length; i--;) {
                                        var c = t = a[i],
                                            s = c.name,
                                            u = c.namespaceURI;
                                        if (r = b(t.value), o = h(s), l.attrName = o, l.attrValue = r, l.keepAttr = !0, l.forceKeepAttr = void 0, st("uponSanitizeAttribute", e, l), r = l.attrValue, !l.forceKeepAttr && (it(s, e), l.keepAttr))
                                            if (A(/\/>/i, r)) it(s, e);
                                            else {
                                                De && (r = y(r, pe, " "), r = y(r, de, " "));
                                                var f = e.nodeName.toLowerCase();
                                                if (ft(f, o, r)) try {
                                                    u ? e.setAttributeNS(u, s, r) : e.setAttribute(s, r), p(n.removed)
                                                } catch (e) {}
                                            }
                                    }
                            ...
                            pt = function e(t) {
                                var n = void 0,
                                    r = lt(t);
                                for (st("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) st("uponSanitizeShadowNode", n, null), ut(n) || (n.content instanceof a && e(n.content), mt(n));
                        ...
                        return n.sanitize = function(e, o) {
                            ...
                            if (Oe || Ze(o), n.removed = [], "string" == typeof e && (He = !1), He);
                            else if (e instanceof c) i = at("\x3c!----\x3e"), 1 === (l = i.ownerDocument.importNode(e, !0)).nodeType && "BODY" === l.nodeName ? i = l : "HTML" === l.nodeName ? i = l : i.appendChild(l);
                            else {
                                if (!Me && !De && !Ne && -1 === e.indexOf("<")) return oe && Ce ? oe.createHTML(e) : e;
                                if (!(i = at(e))) return Me ? null : ie
                            }
                            i && Le && ot(i.firstChild);
                            for (var m = lt(He ? e : i); s = m.nextNode();) 3 === s.nodeType && s === u || ut(s) || (s.content instanceof a && pt(s.content), mt(s), u = s);
                            if (u = null, He) return e;
                            if (Me) {
                                if (Fe)
                                    for (f = se.call(i.ownerDocument); i.firstChild;) f.appendChild(i.firstChild);
                                else f = i;
                                return Ie && (f = ue.call(r, f, !0)), f
                            }
                            var p = Ne ? i.outerHTML : i.innerHTML;
                            return De && (p = y(p, pe, " "), p = y(p, de, " ")), oe && Ce ? oe.createHTML(p) : p
